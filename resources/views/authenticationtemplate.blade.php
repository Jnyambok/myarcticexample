...
<body>
    ...
    <div class="main_menu">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
          <a class="navbar-brand logo_h" href="index.html"><img src="{{asset('templateresources/img/logo.png')}}" alt=""></a>
 ...
 <!--INSERT LARAVELS LOGIN PAGE-->

				<div class="col-lg-6">
					<div class="login_form_inner">
						@yield('login-form-header')
						@yield('login-reg-form')
					</div>
				</div>
			</div>
		</div>
